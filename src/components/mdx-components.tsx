...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    h4: ({ className, ...props }) => (
      <h4
        className={cn('text-xl font-semibold tracking-tight mt-4 mb-2 font-sans', className)}
        {...props}
      />
    ),
    p: ({ className, ...props }) => (
    ...
    blockquote: ({ className, ...props }) => (
      <blockquote
        className={cn(
          'border-l-4 border-primary pl-4 py-2 my-4 italic text-muted-foreground',
          className
        )}
        {...props}
      />
    ...
    pre: ({ className, ...props }) => (
      <pre
        className={cn(
          'overflow-x-auto rounded-lg bg-muted p-4 mb-4 font-mono text-sm',
          className
        )}
        {...props}
      />
